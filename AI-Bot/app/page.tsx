  ...
  const features = [
    {
      ...
      description: "Np joins your calls automatically, ensuring no moment is missed.",
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <header className="flex items-center justify-between py-6 border-b-2 border-ink">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-xl font-black tracking-tight">Np</span>
          </div>
          <button
        ...
        <section className="relative py-16 md:py-24">
          ...
          <p className="mt-6 max-w-xl text-lg text-muted-foreground">
            Drop a Google Meet, Zoom, or Teams link. <strong>Np</strong> joins the call, records everything,
        ...
        <section id="features" className="pb-20">
          <div className="mb-8">
            ...
            <h2 className="mt-3 text-4xl font-black leading-tight sm:text-5xl">
              Drop a link.{" "}
              <span className="text-muted-foreground">Np handles the rest.</span>
            </h2>
          </div>
            ...
            <div className="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-lg text-sm font-bold opacity-90">
                  Paste a meeting URL and let Np do the work. No setup needed.
                </p>
              </div>
              <button
              ...
              >
                <Bot className="h-4 w-4" /> Deploy Np Now
              </button>
            </div>
          </div>
        </section>
