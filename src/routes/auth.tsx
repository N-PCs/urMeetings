  ...
  return (
    <div className="grid min-h-dvh place-items-center bg-background px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl ink-border bg-card p-6 pop-lg sm:p-8 text-center">
          <h1 className="text-3xl font-black tracking-tight">Sign in</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Sign in with Google to see your notes and Q&A.
          </p>
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 flex h-12 w-full items-center justify-center gap-3 rounded-xl border-2 border-ink/20 bg-background text-sm font-black pop disabled:opacity-60"
          >
            {loading ? (
