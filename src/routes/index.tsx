    ...
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <section className="relative py-10 md:py-16">
          <ScrollDecor
            speed={0.35}
            className="pointer-events-none absolute -left-4 top-2 hidden md:block"
          >
          ...
          <ScrollDecor
            speed={0.25}
            className="pointer-events-none absolute -right-2 bottom-0 hidden md:block"
          >
          ...
          <div className="grid items-center gap-10 md:grid-cols-[minmax(0,1fr)_minmax(0,420px)] md:gap-8">
            <div className="max-w-2xl">
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                <span className="text-sm font-bold">Use as floating overlay</span>
                <button
          ...
          <Parallax speed={0.2}>
            <div className="relative mx-auto max-w-3xl rounded-3xl ink-border bg-yellow p-6 pop-lg sm:p-10">
              ...
              <div className="mt-4 flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-full ink-border bg-violet text-lg font-black text-primary-foreground">
                  N
                </span>
                <div>
                  <div className="text-sm font-black">Neel · N-PCs</div>
                  <div className="text-xs font-bold text-muted-foreground">
                    Person who kept forgetting action items
                  </div>
                </div>
              </div>
            </div>
